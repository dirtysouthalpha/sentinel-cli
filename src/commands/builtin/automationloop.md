---
name: automationloop
description: Bootstrap and run an autonomous PLAN -> ACT -> AUDIT -> REPEAT loop until the goal is 100% complete. Pass a goal after the command, or run it bare to resume from project_state.md.
agent: gsd
---

...
export class ConfigManager {
  ...
  load(): SentinelConfig {
    ...
    // Deep-merge in layers: defaults < global < project. A flat
    // `{ ...globalConfig, ...projectConfig }` would let any top-level key in the
    // project file (provider, permissions, mcp, skills) wholesale replace the
    // global object — e.g. a project `provider` block erasing global API keys.
